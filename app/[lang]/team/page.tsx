        ...
        {teamMembers.map((member) => (
         ...
         <article
          ...
          >
            ...
            <div className="mt-4 space-y-2 text-center">
              <h2 className="text-lg font-semibold text-gray-900 leading-tight">Inácio Oliveira</h2>
              <p className="text-sm font-medium text-blue-700">Desenvolvedor</p>
              <p className="text-sm text-gray-600 flex items-center justify-center gap-2">
                <FaGraduationCap className="size-4" aria-hidden="true" />
            ...
            <div className="mt-5 grid gap-2 text-sm">
              <a
                href="http://lattes.cnpq.br/2132455106757075"
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-gray-700 transition hover:bg-gray-50"
              >
              ...
              <a
                href="https://github.com/inacioigne"
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-gray-700 transition hover:bg-gray-50"
              >
